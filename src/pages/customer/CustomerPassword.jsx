  ...
  return (
    <div css={pageStyles}>
      <div css={sidebarStyles}>
        ...
        <Link to="/customer/profile/password" css={sidebarLinkStyles} className="active">
          <div css={iconWrapperStyles} className="icon-wrapper">
            <Lock size={24} css={iconStyles} className="icon" />
          </div>
        </Link>
      </div>
      <div css={mainContentStyles}>
        ...
        <div css={formStyles}>
          <h1 css={css`font-size: 24px; color: #1dbf1d; margin-bottom: 20px;`}>Change Password</h1>
          <form onSubmit={handleSubmit}>
            ...
            />
            <button type="submit" css={buttonStyles}>Update Password</button>
          </form>
        </div>
      </div>
    </div>
